    ...
    <>
      <main>
        ...
        <section id="section-2">
          <div img-title="tomorrowland" className="titles">
            <div className="title">
              <small>2020 - ONGOING</small>
              <h1>Tomorrowland</h1>
            </div>
          </div>
          <div img-title="navy-pier" className="titles">
            <div className="title">
              <small>2018 - TODAY</small>
              <h1>Navy Pier</h1>
            </div>
          </div>
          <div img-title="msi-chicago" className="titles">
            <div className="title">
              <small>2015 - TODAY</small>
              <h1>MSI Chicago</h1>
            </div>
          </div>
          <div img-title="phone" className="titles">
            <div className="title">
              <small>2016</small>
              <h1>This Was Louises's Phone</h1>
            </div>
          </div>
          <div img-title="kikk" className="titles">
            <div className="title">
              <small>2012 - TODAY</small>
              <h1>KIKK Festival 2018</h1>
            </div>
          </div>
          <div img-title="kennedy" className="titles">
            <div className="title">
              <small>2017</small>
              <h1>The Kennedy Center</h1>
            </div>
          </div>
          <div img-title="opera" className="titles">
            <div className="title">
          ...
          <div className="bottom">
              <div className="right">
                <p>
                  ...
                  Chicago. <br />
                  Our strong focus on producing <br /> high quality & emotional{" "}
                  <br /> brandings, digital products and <br /> experiences
                  became a signature.
                </p>
                <p>
                  We’re passionate about moving <br /> people and solving
                  problems for <br /> the likes of Microsoft, The <br /> Museum
                  of Science And Industry <br /> Of Chicago, The Kennedy Center{" "}
                  <br /> of Washington, Dragone, Quanta <br /> Magazine, and
                  many more.
                </p>
              </div>
              <div className="ender">
        ...
        <section id="section-5">
          ...
          <div className="bottom">
            <div className="footer">
              <p>We'd love to hear from you --- <span>biz@dogstudio.be</span></p>
              <p>Privacy Policy</p>
            </div>
          </div>
        </section>
